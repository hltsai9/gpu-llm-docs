  ...
  "questions": [
    {
      ...
      "choices": {
        "A": "在產品目錄上做 full fine-tune",
        "B": "RAG —— 查詢時從目錄抓對應內容塞進 prompt",
        "C": "在目錄 PDF 上做 LoRA",
        "D": "把 prompt 調得更用力"
      },
    ...
    },
    {
      ...
      "choices": {
        "A": "可訓練參數變 10× 小",
        "B": "QLoRA 完全不需要梯度",
        "C": "凍住的 base 以 4-bit 精度存,靜態權重的 VRAM 大幅下降",
        "D": "QLoRA 只跑 CPU,完全不用 GPU"
      },
    ...
    },
    {
      ...
      "choices": {
        "A": "50,000 筆普通的 —— 資料多永遠比較好",
        "B": "500 筆整理過的 —— narrow 任務,品質比數量重要",
        "C": "兩者實務上效果一樣",
        "D": "只看 learning rate"
      },
